...
export ZSH="/Users/markoss/.oh-my-zsh"
...
# e.g. here we add the Git information in blue and path in red
PROMPT='%F{red}%~ %F{blue}${vcs_info_msg_0_}%f$ '
